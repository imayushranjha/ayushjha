...
if choice1 == "left" :
          ...
          if choice2 == "wait" :
                    choice3 = input("You arrived at the island unharmed.There is a house with three doors one red one yellow and one blue.Which colour you choose (Red,Blue or Red)\n").lower()
                    if choice3 == "yellow":
                              print("You Win")
                    elif choice3 == "red":
